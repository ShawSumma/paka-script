...
`;
    ...
    Node readExprMatch(Binding type)
    {
        ...
        if (state.first == '\'')
        {
            ...
            return new Value(chr.to!double);
        }
        ...
        case "let":
            ...
            return new Form("do", new Form("set", id, value), inscope);
        case "for":
            Node value = readExprMatch(Binding.none);
            Ident id = new Ident(readName);
            mixin(hasScope);
    ...
    Node readDefStmt()
    {
        ...
        {
            return new Form("set", new Form("call", new Ident(fname), argNames), readExprMatch(Binding.none));
        }
    }
    ...
    Node readStmt()
    {
        ...
        {
            state.skip;
            return readExprMatch(Binding.none);
        }
        else
        {
            return readDefStmt;
